...
## Saves/loads to disk automatically
...
var player := {
	...
	"int": 5,
	"vit": 5,
	"entropy": 0,         # the unique mechanic — entropy builds as the world decays
	"entropy_max": 100,
	"gold": 0,
	"inventory": [],
	"equipped": {},
...
var world := {
	...
	"day": 1,
	"time_of_day": "morning",   # morning / afternoon / dusk / night
	"faction_rep": {},           # faction_name: int (-100 to 100)
	"discovered_areas": [],
	"defeated_bosses": [],
}
...
var flags: Dictionary = {}      # string key → any value
